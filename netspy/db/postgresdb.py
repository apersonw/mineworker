...
需要 ``pip install netspy[postgres]``。接口与 :class:`~netspy.db.mysqldb.MysqlDB`
对齐，方便 :mod:`~netspy.pipelines._sql` 复用同一套骨架。仅在实际实例化时才 import psycopg。
"""
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ImportError("PostgreSQL 支持需 pip install netspy[postgres]") from exc
